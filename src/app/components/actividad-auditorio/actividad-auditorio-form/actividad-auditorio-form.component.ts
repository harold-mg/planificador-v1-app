...
import { ActividadAuditorioService } from 'src/app/services/actividad-auditorio.service'; // Servicio para manejar actividades de auditorio
...
@Component({
  selector: 'app-actividad-auditorio-form',
  templateUrl: './actividad-auditorio-form.component.html',
  styleUrls: ['./actividad-auditorio-form.component.scss']
})
export class ActividadAuditorioFormComponent implements OnInit {
  ...
  constructor(
    ...
    private actividadAuditorioService: ActividadAuditorioService, // Servicio de actividades de auditorio
    ...
    this.actividadForm = this.fb.group({
      ...
      plataforma: ['', Validators.required],  // Campo de texto para la plataforma
  ...
  onSubmit(): void {
    ...
    if (this.actividadForm.valid) {
      ...
      this.actividadAuditorioService.createActividadAuditorio(this.actividadForm.value).subscribe({
        next: () => {
          console.log('Actividad de auditorio registrada exitosamente');
          alert('Actividad de auditorio registrada exitosamente');
          window.location.reload(); // Recargar la página después del registro
        },
        error: (err) => {
          console.error('Error al registrar la actividad de auditorio:', err);
