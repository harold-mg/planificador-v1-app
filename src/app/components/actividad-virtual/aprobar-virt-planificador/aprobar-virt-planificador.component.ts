...
@Component({
  selector: 'app-aprobar-virt-planificador',
  templateUrl: './aprobar-virt-planificador.component.html',
  styleUrls: ['./aprobar-virt-planificador.component.scss']
})
export class AprobarVirtPlanificadorComponent {
  actividades: any[] = [];
  ...
  constructor(
    private actividadVirtualService: ActividadVirtualService, // Servicio para actividades de auditorio
  ...
  aprobarActividad(id: number): void {
    this.actividadVirtualService.aprobarActividadPorPlanificador(id).subscribe(
      response => {
