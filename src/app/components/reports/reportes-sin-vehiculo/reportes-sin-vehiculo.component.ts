...
@Component({
  selector: 'app-reportes-sin-vehiculo',
  templateUrl: './reportes-sin-vehiculo.component.html',
  styleUrls: ['./reportes-sin-vehiculo.component.scss']
})
export class ReportesSinVehiculoComponent {
  meses = [
    { label: 'Enero', value: 1 },
  ...
  generarReporteMensual() {
    ...
    this.reportesService.getReporteMensualSinVehiculo(this.mesSeleccionado, this.yearSeleccionado).subscribe(
      (blob: Blob) => {
