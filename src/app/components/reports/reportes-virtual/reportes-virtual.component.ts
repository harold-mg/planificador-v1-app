...
@Component({
  selector: 'app-reportes-virtual',
  templateUrl: './reportes-virtual.component.html',
  styleUrls: ['./reportes-virtual.component.scss']
})
export class ReportesVirtualComponent {
  meses = [
    { label: 'Enero', value: 1 },
  ...
  generarReporteMensual() {
    ...
    this.reportesService.getReporteMensualVirtual(this.mesSeleccionado, this.yearSeleccionado).subscribe(
      (blob: Blob) => {
